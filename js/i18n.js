const i18nData = {
  en: {
    ...
    securityDesc1:
      "Kernel Isolation: Deep integration with sandboxed environments and Docker.",
    securityDesc2:
      "Permission Guard: Fine-grained token control and execution auditing.",
    securityDesc3:
      "Data Privacy: Local-first architecture ensuring zero data leakage.",
    enterpriseTitle: "Enterprise Management",
    enterpriseDesc1: "Centralized configuration & management.",
    enterpriseDesc2: "Fine-grained permission control.",
    enterpriseDesc3: "Operation audit logs.",
    enterpriseDesc4: "Multi-factor authentication.",
    enterpriseDesc5: "End-to-end data encryption.",
    flexibleTitle: "Flexible Integration",
    flexibleDesc:
      "Seamlessly integrate via Skills, MCP, Sub-agents, and custom Plugins.",
    testimonialsTitle: "User Reviews",
    testi1:
      '"The seamless integration between the orchestrator and the local execution space completely changed my AI workflow."',
    author1Name: "Alex Chen",
    author1Role: "Senior Software Engineer",
    testi2:
      '"Butler Mode feels like having a real assistant. It handles calendar events and RSS pulling autonomously in the background!"',
    author2Name: "Sarah Jenkins",
    author2Role: "Product Manager",
    testi3:
      '"I love how I can deploy pure frontend tools without heavy configuration. This toolkit is incredibly powerful yet easy to spin up."',
    author3Name: "David Wu",
    author3Role: "Indie Hacker",
    testi4:
      '"The Classic mode thread sorting and file viewing are unparalleled. I can track my multi-agent logic so much faster now."',
    author4Name: "Elena Rostova",
    author4Role: "AI Researcher",
    testi5:
      '"Deployment worked right out of the box. Absolutely stunning interface with no build step required."',
    ...
    footerDesc:
      "Built for true AI automation.<br>Local workspace orchestration.",
  ...
  zh: {
    ...
    subtitle:
      "不只是聊天，也不只是龙虾，而是让 Agent 在本地工作区里安全的调用工具、执行任务、持续编排。",
    warningTitle: "注意",
    warningText:
    ...
    classicDesc3:
      "聊天区：流式对话与工具调用，支持语音输入/播报，图片与文档附件。",
    ...
    coreTech: "核心架构",
    securityTitle: "安全边界",
    securityDesc1: "内核隔离：深度集成沙盒环境与 Docker 容器化技术。",
    securityDesc2: "权限守卫：细粒度的 Token 控制与全量执行审计。",
    securityDesc3: "数据隐私：全本地架构设计，确保数据永不外泄。",
    enterpriseTitle: "企业管理",
    enterpriseDesc1: "统一配置管理与集中化管控。",
    enterpriseDesc2: "细粒度的权限访问控制。",
    enterpriseDesc3: "完善的操作审计日志。",
    enterpriseDesc4: "多因子身份认证方案。",
    enterpriseDesc5: "端到端的数据加密保护。",
    flexibleTitle: "灵活扩展",
    flexibleDesc:
      "支持 Skills、MCP、Sub-agents 及各类插件的无缝接入，实现多种技能任意集成。<br>提供企业市场进行统一管控与监督，批量更新管理技能。<br>支持自定义技能，实现企业级技能管理。",
    testimonialsTitle: "使用者评价",
    testi1: "“编排器与本地执行空间的无缝集成彻底改变了我的 AI 工作流。”",
    author1Name: "Alex Chen",
    author1Role: "高级软件工程师",
    testi2:
      "“Butler 模式就像拥有一个真正的助手，它能在后台自主处理日历事件和 RSS 拉取！”",
    author2Name: "Sarah Jenkins",
    author2Role: "产品经理",
    testi3:
      "“我喜欢无需繁重配置即可部署纯前端工具的方式。这个工具包功能强大且极易上手。”",
    author3Name: "David Wu",
    author3Role: "独立开发者",
    testi4:
      "“Classic 模式的线程排列与文件查看无与伦比，能让我更快地追踪多 Agent 逻辑。”",
    author4Name: "Elena Rostova",
    author4Role: "AI 研究员",
    testi5: "“部署开箱即用，界面令人惊艳，无需构建步骤。”",
    author5Name: "Marcus Taylor",
    author5Role: "前端架构师",
    ...
    pfTitle2: "完全安全",
    pfDesc2:
      "本地工作区隔离确保您的数据永不离开您的电脑。提供容器虚拟运行时，保证运行时安全。",
    pfTitle3: "企业级防护",
    pfDesc3:
      "专门为企业打造统一配置管理、细粒度权限控制、操作审计日志、多因子认证、数据加密。",
    pfTitle4: "智能记忆",
