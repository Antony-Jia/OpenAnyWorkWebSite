const i18nData = {
    en: {
        ...
        securityDesc1: "Kernel Isolation: Deep integration with sandboxed environments and Docker.",
        securityDesc2: "Permission Guard: Fine-grained token control and execution auditing.",
        securityDesc3: "Data Privacy: Local-first architecture ensuring zero data leakage.",
        ...
        flexibleDesc: "Seamlessly integrate via Skills, MCP, Sub-agents, and custom Plugins.",
        ...
        testi5: "\"Deployment worked right out of the box. Absolutely stunning interface with no build step required.\"",
    ...
    zh: {
        ...
        subtitle: "不只是聊天,也不只是龙虾，而是让 Agent 在本地工作区里安全的调用工具、执行任务、持续编排。",
        warningTitle: "注意",
        ...
        flexibleTitle: "灵活扩展",
        flexibleDesc: "支持 Skills、MCP、Sub-agents 及各类插件的无缝接入，实现多种技能任意集成。<br>提供企业市场进行统一管控与监督，批量更新管理技能。<br>支持自定义技能，实现企业级技能管理。",
        ...
        pfTitle2: "完全安全",
        pfDesc2: "本地工作区隔离确保您的数据永不离开您的电脑。提供容器虚拟运行时，保证运行时安全。",
        pfTitle3: "企业级防护",
        pfDesc3: "专门为企业打造统一配置管理、细粒度权限控制、操作审计日志、多因子认证、数据加密。",
        pfTitle4: "智能记忆",
